...
## Installation
lpcpp requires CMake, a compiler supporting C++23, and the [IntelTBB](https://www.intel.com/content/www/us/en/docs/onetbb/get-started-guide/2022-1/overview.html) and [OpenCV 5](https://docs.opencv.org/5.0/tutorials/introduction/table_of_content_introduction.html) libraries.
